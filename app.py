...
def optimize_portfolio(data, risk_tolerance):
    ...
    # Define objective function (minimize risk or maximize return)
    ...
    # Optimization based on risk tolerance
    if risk_tolerance == "Low":
        ...
        def neg_sharpe(weights):
            ...
            return -port_return / port_volatility  # Maximize Sharpe Ratio
...
# Stock Tickers (Can be dynamic based on industry/market)
tickers = ["AAPL", "MSFT", "TSLA", "NVDA", "AMZN", "GOOGL", "META", "NFLX", "JPM", "V"]
...
if st.button("Generate Portfolio"):
    ...
    if model == "Modern Portfolio Theory (MPT)":
        ...
        momentum = (data.iloc[-1] / data.iloc[0]) - 1  # Calculate 1-year momentum
        top_momentum_stocks = momentum.nlargest(5)  # Select top 5 momentum stocks
